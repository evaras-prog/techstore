...
//Valida que el email tenga formato correcto y dominio permitido
...
function validarFormLogin(event){
    ...
    localStorage.setItem("rolActual", usuarioEncontrado.tipo);

    alert("Bienvenido " + usuarioEncontrado.nombre + " a TechStore");
